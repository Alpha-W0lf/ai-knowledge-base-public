...
**Guide 01:** Implemented (pass 8) / reviewed shippable (pass 9) — shared spine + fixtures + CE seam. **Guide 02:** Packaging DoD implemented (LICENSE, empty channels + ignored overlay, path hygiene). **Guide 03:** This **public sibling** is the portfolio public surface; private archive remains private. **Guide 04:** Root `GETTING_STARTED.md` + `INTERVIEW.md` — stranger-clone + FAQ packaging; **not** v1 complete / private flip / eval-complete. Optional private tip scrub is separate hygiene — not required for “having a public AI KB.”
